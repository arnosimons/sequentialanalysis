...
- Stage 1 (`tell_stories`): generate multiple plausible everyday situations in which the fragment would occur verbatim and make sense, without any case context, as well as two unplausible situations for contrast. This deliberately opens up interpretive space and surfaces an everyday understanding of the sequence before any contextual narrowing.
